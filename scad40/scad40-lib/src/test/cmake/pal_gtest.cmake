...
###
### 2015-10-25 ;
###			- fixes? to the test macro ; now actually can do multi-file-tests
### 2015-07-31 ;
...
if(NOT DEFINED pal__gtest)
	...
	# create a macro we'll have to use :(
	macro(pal_gtest_wire name)
		target_link_libraries(${name} gtest gtest_main)
		
		add_custom_command(TARGET ${name}
			PRE_BUILD
			COMMAND ${CMAKE_COMMAND} -E copy_if_different $<TARGET_FILE:gtest> $<TARGET_FILE_DIR:${name}>
			MAIN_DEPENDENCY gtest)
		add_custom_command(TARGET ${name}
			PRE_BUILD
			COMMAND ${CMAKE_COMMAND} -E copy_if_different $<TARGET_FILE:gtest_main> $<TARGET_FILE_DIR:${name}>
