...
/// macro from another project - invokes a duktape call then blows up if somethign goes wrong
...
{ 
	...
	std::cout << CMAKE_SOURCE_DIR "/scala-js/target/scala-2.11/hello-sbtw-fastopt.js" << std::endl;

	// create a DukTap VM
	duk_context* ctx = duk_create_heap_default();

	// run the script generated by Scala-JS
	GOOSE_CRITICAL_CALL(duk_peval_file_noresult, (ctx, CMAKE_SOURCE_DIR "/scala-js/target/scala-2.11/hello-sbtw-fastopt.js"), duk_safe_to_string(ctx, -1));
